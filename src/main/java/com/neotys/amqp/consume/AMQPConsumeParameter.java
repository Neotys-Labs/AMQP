...
enum AMQPConsumeParameter {
	...
	EXCHANGEAUTODELETE("exchange.autoDelete", Optional, False, TEXT, "", "If set to true, the created exchange will be auto deleted if not used. Default value is false.", BOOLEAN_VALIDATOR),
